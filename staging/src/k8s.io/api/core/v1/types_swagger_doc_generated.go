...
var map_RBDPersistentVolumeSource = map[string]string{
	...
	"backendType": "Optional: BackendType is client type to use for mapping RBDImage to a block device, default is \"krbd\". Tip: Ensure that the backend is supported by the host operating system. Examples: \"krbd\", \"rbd-nbd\". Implicitly inferred to be \"krbd\" if unspecified. More info: http://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it",
}
